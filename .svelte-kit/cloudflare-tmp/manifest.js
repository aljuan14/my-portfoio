	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/spotify/_server.js'))
			},
			{
				id: "/api/u/c/api/send",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/u/c/api/send/_server.js'))
			},
			{
				id: "/api/u/s",
				pattern: /^\/api\/u\/s\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/u/s/_server.js'))
			},
			{
				id: "/blog",
				pattern: /^\/blog\/?$/,
