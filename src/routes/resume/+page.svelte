	...
	>
		...
		<div class="flex flex-col sm:flex-row gap-12">
			...
			<div class="flex-1 flex flex-col gap-8">
				...
				<section>
					<h2
						class="text-xl font-bold uppercase border-b border-gray-300 pb-1 mb-3 text-gray-900 tracking-wide"
					>
						TENTANG SAYA
					</h2>
				...
				<section>
					<h2
						class="text-xl font-bold uppercase border-b border-gray-300 pb-1 mb-4 text-gray-900 tracking-wide"
					>
						PROYEK SAYA
					</h2>
								...
								<h3 class="font-bold text-base mb-1">
									...
									{#if project.url && project.name !== 'Sistem Pendeteksi Suku dari Wajah'}
										- <a
											...
											target="_blank"
											class="text-blue-600 hover:underline font-normal text-xs"
								...
								<p class="leading-relaxed">
									...
									{#if project.name === 'Sistem Pendeteksi Suku dari Wajah' && project.url}
										<br /><a
											href={project.url}
											target="_blank"
											class="text-blue-600 hover:underline font-medium mt-1 inline-block"
											>Lihat Jurnal Publikasi &rarr;</a
										>
									{/if}
								</p>
						...
						{#each cv.socials as social}
							<li class="flex items-center gap-2">
								...
								{:else}
									...
									>
								{/if}
								<a href={social.url} target="_blank" class="hover:underline"
									>{social.url.replace('https://', '')}</a
								>
							</li>
						{/each}
					</ul>
